...
public class Minecraft12110ChatHistoryProvider implements ChatHistoryProvider {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (includeJson) {
                try {
                    ...
                    // resolve (rare for chat). Leave dto.json null; the omit-nulls
                    // serializer drops the field. plain is still there.
                }
            }
            out.add(dto);
        }
